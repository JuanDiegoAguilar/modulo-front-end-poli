(function () {
  ...
  function showState(container, message) {
    ...
    p.className = 'col-span-full py-12 text-center text-[0.95rem] text-[#9B9B9B]';
  ...
  function initServices() {
    ...
    fetch(SERVICES_URL)
      ...
      .catch(function () {
        showState(
          container,
          'No se pudieron cargar los servicios. Abre la página con un servidor local (por ejemplo Live Server) para que el JSON sea accesible.'
        );
      });
  }
